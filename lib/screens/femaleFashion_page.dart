...
class FemaleFashionPage extends StatelessWidget {
...
class FemaleFashion extends StatefulWidget {
  @override
  _ProductsState createState() => _ProductsState();
}

class _ProductsState extends State<FemaleFashion> {
  List<ProductModel> product_list = [];

  void getProductById() {
    findByCategoryIdTwo().then((res) {
